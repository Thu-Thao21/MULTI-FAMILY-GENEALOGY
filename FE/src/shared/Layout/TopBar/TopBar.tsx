        ...
        <div className="topbar-profile-wrapper">
          ...
          {showProfileMenu && (
            <div className="topbar-profile-dropdown">
              ...
              <button className="topbar-menu-item" onClick={() => handleNavigate('/clan-admin/profile')}>
                Hồ sơ cá nhân
              </button>

              <button className="topbar-menu-item" onClick={() => handleNavigate('/clan-admin/settings')}>
                Cài đặt tài khoản
              </button>

              <div className="topbar-profile-divider" />

              <button onClick={() => { setShowProfileMenu(false); onLogout(); }} className="topbar-menu-item-logout">
                Đăng xuất
              </button>
            </div>
          )}
