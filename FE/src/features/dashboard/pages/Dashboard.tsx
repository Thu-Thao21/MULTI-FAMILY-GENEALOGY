...
export const Dashboard: React.FC<DashboardProps> = ({ userName, onLogout }) => {
  ...
  return (
    ...
    >
      {/* 1. Fixed Top Bar (Search Bar, Profile Role, Notifications) */}
      <TopBar
        userName={userName}
        userRole={userRole}
        onLogout={onLogout}
      ...
      {/* Main Container: Left Sidebar + Center Area */}
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        >
          {/* A. Banner Lời Chào Cá Nhân Hóa & 4 Thẻ Thống Kê Nhanh */}
