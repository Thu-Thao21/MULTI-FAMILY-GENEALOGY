  ...
  if (loading) {
    return (
      <div style={{ padding: '60px', textAlign: 'center', color: '#64748b' }}>
        Đang tải thông tin chi tiết hồ sơ thành viên từ PostgreSQL...
      </div>
    );
  }
  ...
  if (!member) {
    return (
      <div style={{ padding: '60px', textAlign: 'center' }}>
        <p style={{ color: '#ef4444', fontWeight: 700 }}>⚠️ Không tìm thấy dữ liệu hồ sơ thành viên.</p>
        {onBack && (
        ...
        <div className="profile-header-top">
          ...
          <div className="profile-header-info">
            ...
            <div className="profile-subtext">
              <span>{member.familyName || 'Dòng họ Nguyễn'}</span>
              <span>•</span>
              <span>{member.branch || 'Chi Trưởng'}</span>
