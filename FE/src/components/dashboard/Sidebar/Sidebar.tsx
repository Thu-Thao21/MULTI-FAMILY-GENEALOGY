...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      {!isCollapsed && (
        <div style={{ padding: '0 10px 12px', fontSize: '11px', fontWeight: 800, color: '#94a3b8', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
          QUẢN LÝ GIA PHẢ
        </div>
      )}
          ...
          <div key={group.id} style={{ marginBottom: '4px' }}>
            <button
              ...
              style={{
                ...
                borderRadius: '14px',
                border: 'none',
                backgroundColor: isGroupActive ? '#eff6ff' : 'transparent',
                color: isGroupActive ? '#2563eb' : '#334155',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <span style={{ display: 'flex', alignItems: 'center', color: isGroupActive ? '#2563eb' : '#64748b' }}>
                  {group.icon}
                </span>
                {!isCollapsed && (
              ...
              {!isCollapsed && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  {group.badge && (
                    <span
                      style={{
                        ...
                        padding: '2px 8px',
                        borderRadius: '999px',
                        backgroundColor: group.id === 'admin' ? '#fef2f2' : '#eff6ff',
                        color: group.id === 'admin' ? '#ef4444' : '#2563eb',
                      }}
                    >
                      {group.badge}
                    </span>
                  ...
                  {!isSingle && (
                    <span style={{ fontSize: '11px', color: '#94a3b8', transition: 'transform 0.2s ease', transform: isExpanded ? 'rotate(180deg)' : 'none' }}>
                      ▼
                    </span>
                  )}
                </div>
