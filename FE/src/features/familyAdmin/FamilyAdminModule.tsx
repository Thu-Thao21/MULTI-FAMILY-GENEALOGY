...
type Props = { view: FamilyAdminView; onNavigate?: (view: FamilyAdminView) => void };
...
export const FamilyAdminModule: React.FC<Props> = ({ view, onNavigate }) => {
